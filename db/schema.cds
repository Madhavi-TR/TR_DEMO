...
entity  
 ...
 ZTR_SO_FLOW_JOIN as select from ZELOQUA as Opp
left outer join ZCONGA as Qte on    Opp.Opp_Id = Qte.Opp_Id 
left outer join ZSAP_ORDER as Ord on Qte.Quote_Id = Ord.Quote_Id  and  Qte.Asset_Id = Ord.Asset_Id
left outer join ZSAP_Delivery as Del on Ord.Order_Id=Del.Order_Id and Ord.Asset_Id= Del.Asset_Id
left outer join ZSAP_INVOICE as Inv on Del.Delivery_Id = Inv.Delivery_Id and Del.Asset_Id = Inv.Asset_Id
{
Key Opp.Opp_Id,
Opp.Opp_Status,
Opp_Docdate,
